...
class GameStatsManager {
  ...
  updatePopularityDisplay() {
    console.log('🔥 开始更新人气值显示...');
    console.log('📊 全局GAMES_DATA:', window.GAMES_DATA);
    console.log('🃏 GAMES_DATA类型:', typeof window.GAMES_DATA);
    console.log('🃏 GAMES_DATA是否为数组:', Array.isArray(window.GAMES_DATA));
